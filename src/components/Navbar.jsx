...
const Navbar = ({ navActive, setNavActive, bodyActive, setBodyActive }) => {
  ...
  useEffect(() => {
    const handleResize = () => {
      ...
      // console.log("Current innerWidth:", width);
    };
    window.addEventListener("resize", handleResize);
  });
  function navbarclose() {
    if (navActive === "Active") {
      ref1.current.style.animationName = "navcloser";
      setNavActive("NotActive");
      setBodyActive("NotActive");
    }
  }
  if (bodyActive === "Active") {
    console.log("nav");
    ref1.current.style.animationName = "navopener";
    setNavActive("Active");
  }

  return (
    <div className="nav" ref={ref1}>
      <div className="inner-nav">
        <div className="nav-button">
          {navActive === "Active" ? (
            <button className="close-button" onClick={navbarclose}>
              <svg
                className="svg"
                width="24"
                height="24"
